package com.erickc.texttooltip;
...
public class TextTooltip {
    ...
    private TextTooltip(MyContext myContext, View view) {
        this.view = view;
    ...
    private TextTooltip(MyContext myContext, View rootView, View view) {
    ...
    private TextTooltip(View view) {
        this(new MyContext(getActivityContext(view.getContext())), view);
    }

    public static TextTooltip on(final View view) {
        return new TextTooltip(new MyContext(getActivityContext(view.getContext())), view);
    }

    public static TextTooltip on(Fragment fragment, final View view) {
        return new TextTooltip(new MyContext(fragment), view);
    }

    public static TextTooltip on(Activity activity, final View view) {
        return new TextTooltip(new MyContext(getActivityContext(activity)), view);
    }

    public static TextTooltip on(Activity activity, final View rootView, final View view) {
        return new TextTooltip(new MyContext(getActivityContext(activity)), rootView, view);
    }
    ...
    public TextTooltip position(Position position) {
        this.tooltip_view.setPosition(position);
        return this;
    }

    public TextTooltip withShadow(boolean withShadow) {
        this.tooltip_view.setWithShadow(withShadow);
        return this;
    }

    public TextTooltip shadowColor(@ColorInt int shadowColor) {
        this.tooltip_view.setShadowColor(shadowColor);
        return this;
    }

    public TextTooltip customView(View customView) {
        this.tooltip_view.setCustomView(customView);
        return this;
    }

    public TextTooltip customView(int viewId) {
        this.tooltip_view.setCustomView(((Activity) view.getContext()).findViewById(viewId));
        return this;
    }

    public TextTooltip arrowWidth(int arrowWidth) {
        this.tooltip_view.setArrowWidth(arrowWidth);
        return this;
    }

    public TextTooltip arrowHeight(int arrowHeight) {
        this.tooltip_view.setArrowHeight(arrowHeight);
        return this;
    }

    public TextTooltip arrowSourceMargin(int arrowSourceMargin) {
        this.tooltip_view.setArrowSourceMargin(arrowSourceMargin);
        return this;
    }

    public TextTooltip arrowTargetMargin(int arrowTargetMargin) {
        this.tooltip_view.setArrowTargetMargin(arrowTargetMargin);
        return this;
    }

    public TextTooltip align(ALIGN align) {
    ...
    public TextTooltip duration(long duration) {
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public TextTooltip color(int color) {
        this.tooltip_view.setColor(color);
        return this;
    }

    public TextTooltip color(Paint paint) {
        this.tooltip_view.setPaint(paint);
        return this;
    }

    public TextTooltip onDisplay(ListenerDisplay listener) {
        this.tooltip_view.setListenerDisplay(listener);
        return this;
    }

    public TextTooltip onHide(ListenerHide listener) {
        this.tooltip_view.setListenerHide(listener);
        return this;
    }

    public TextTooltip padding(int left, int top, int right, int bottom) {
    ...
    public TextTooltip animation(TooltipAnimation tooltipAnimation) {
        this.tooltip_view.setTooltipAnimation(tooltipAnimation);
        return this;
    }

    public TextTooltip text(String text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public TextTooltip text(@StringRes int text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public TextTooltip corner(int corner) {
        this.tooltip_view.setCorner(corner);
        return this;
    }

    public TextTooltip textColor(int textColor) {
        this.tooltip_view.setTextColor(textColor);
        return this;
    }

    public TextTooltip textTypeface(Typeface typeface) {
        this.tooltip_view.setTextTypeface(typeface);
        return this;
    }

    public TextTooltip textSize(float textSize) {
        this.tooltip_view.setTextSize(textSize);
        return this;
    }

    public TextTooltip margin(int left, int top, int right, int bottom) {
        this.tooltip_view.setMargin(left, top, right, bottom);
        return this;
    }

    public TextTooltip textGravity (int textGravity) {
        this.tooltip_view.setTextGravity(textGravity);
        return this;
    }

    public TextTooltip clickToHide(boolean clickToHide) {
        this.tooltip_view.setClickToHide(clickToHide);
        return this;
    }

    public TextTooltip autoHide(boolean autoHide, long duration) {
        this.tooltip_view.setAutoHide(autoHide);
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public TextTooltip distanceWithView(int distance) {
        this.tooltip_view.setDistanceWithView(distance);
        return this;
    }

    public TextTooltip border(int color,float width){
...
public static class ZoomTooltipAnimation implements TooltipAnimation {

    private long zoomDuration = 400;

    public ZoomTooltipAnimation() {
    }

    public ZoomTooltipAnimation(long zoomDuration) {
...
public static class CardFlipTooltipAnimation implements TooltipAnimation {

    private long flipDuration = 400;

    public CardFlipTooltipAnimation() {
    }

    public CardFlipTooltipAnimation(long flipDuration) {
    ...
    public void animateEnter(View view, Animator.AnimatorListener animatorListener) {
        view.setAlpha(0);
        view.setRotationY(-90);  // Start rotated along Y axis
        view.animate()
            .rotationY(0)        // Rotate to 0 to simulate flipping in
            .alpha(1)            // Fade in
    ...
    public void animateExit(View view, Animator.AnimatorListener animatorListener) {
        view.animate()
            .rotationY(90)       // Rotate out to 90 degrees (flip out)
            .alpha(0)            // Fade out
            .setDuration(flipDuration)
            .setListener(animatorListener);
    }
...
public static class RotateTooltipAnimation implements TooltipAnimation {

    private long rotateDuration = 500;

    public RotateTooltipAnimation() {
    }

    public RotateTooltipAnimation(long rotateDuration) {
        this.rotateDuration = rotateDuration;
    }

    @Override
    public void animateEnter(View view, Animator.AnimatorListener animatorListener) {
        view.setRotation(0);  // Start at 0 degrees
        view.setAlpha(0);
        view.animate()
...
public static class ZoomBounceTooltipAnimation implements TooltipAnimation {

    private long zoomDuration = 500;

    public ZoomBounceTooltipAnimation() {
    }

    public ZoomBounceTooltipAnimation(long zoomDuration) {
        this.zoomDuration = zoomDuration;
    }
    ...
    public void animateEnter(View view, Animator.AnimatorListener animatorListener) {
        ...
        view.animate()
            ...
            .scaleY(1)
            .alpha(1)
            .setInterpolator(new BounceInterpolator())  // Bounce effect
            .setDuration(zoomDuration)
            .setListener(animatorListener);
    }
    ...
    public static class TooltipView extends FrameLayout {
        ...
        public void setTextSize(float size) {
            if (childView instanceof TextView) {
                ((TextView) this.childView).setTextSize(size);
            }
            postInvalidate();
        }
